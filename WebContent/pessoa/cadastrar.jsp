...
<div class="container">
	<div class="row">
		<div class="col-xl-12">
			...
			<form action="${pageContext.request.contextPath}/pessoa/cadastrar"
				method="POST">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="numCep" id="numCep" maxlength="8">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="numRenda" id="numRenda" step=".01">
				</div>
				<div class="form-group">
				...
				<div class="form-group  form-check">
					<input type="checkbox" class="form-check-input" name="chkAtivo" id="chkAtivo"
						checked="checked">
