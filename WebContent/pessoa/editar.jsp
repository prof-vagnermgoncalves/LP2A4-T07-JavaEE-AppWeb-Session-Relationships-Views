			...
			<form action="${pageContext.request.contextPath}/pessoa/editar"
				...
				<div class="form-group">
					<label for="txtNome">Nome</label> <input type="text"
						...
						required="required" value="<%=p.getNomePessoa()%>">
						<input type="hidden" name="numIdPessoa" id="numIdPessoa"
						value="<%=p.getIdPessoa()%>">
				</div>
				<div class="form-group">
					<label for="txtEndereco">Endereço</label> <input type="text"
						class="form-control" name="txtEndereco" id="txtEndereco"
						multiple="multiple" value="<%=p.getEnderecoPessoa()%>">
				</div>
				<div class="form-group">
					<label for="numCep">CEP</label> <input type="number"
						class="form-control" name="numCep" id="numCep" maxlength="8"
						value="<%=p.getCepPessoa()%>">
				</div>
				<div class="form-group">
					<label for="txtTelefone">Telefone</label> <input type="tel"
						class="form-control" name="txtTelefone" id="txtTelefone"
						maxlength="20" value="<%=p.getTelefonePessoa()%>">
				</div>
				<div class="form-group">
					<label for="txtEmail">E-mail</label> <input type="email"
						...
						value="<%=p.getEmail()%>"> <small id="emailHelp"
						class="form-text text-muted">Nós nunca compartilharemos o
						seu e-mail com ninguém mais.</small>
				</div>
				<div class="form-group">
					<label for="numRenda">Renda</label> <input type="number"
						class="form-control" name="numRenda" id="numRenda"
						value="<%=p.getRendaPessoa()%>" step=".01">
				</div>
				<div class="form-group">
				...
				<div class="form-group  form-check">
					<input type="checkbox" class="form-check-input" name="chkAtivo"
						id="chkAtivo" <%=chkAtivoStatus%>> <label
						class="form-check-label" for="chkAtivo">Ativo</label>
				</div>
				<div class="form-group">
					<input type="submit" class="btn btn-primary" name="btnEnviar"
						value="Atualizar"> <input class="btn btn-secondary"
